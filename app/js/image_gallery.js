...
var ImageGallery = function(data) {
  ...
  this.GalleryController.init(this.Gallery, this.ImageView, this.ImageGroupView);
...
ImageGallery.prototype.GalleryController = {
  ...
  init: function(Gallery, ImageView, ImageGroupView) {
    this.gallery = Gallery;
    this.parentContainer = $('#imageGalleryUI');
